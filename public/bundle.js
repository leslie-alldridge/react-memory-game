...
var App = function App(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_Board2.default, { width: props.width / 2 })
    );
};
...
var _createBoard = __webpack_require__(30);
...
var Board = function (_React$Component) {
    ...
    function Board(props) {
        ...
        _this.state = {
            board: (0, _createBoard2.default)(4),
    ...
    _createClass(Board, [{
        key: 'checkPairs',
        value: function checkPairs(cell) {
            var _this2 = this;
            ...
            var _state = this.state,
                ...
                correctCells = _state.correctCells; //defining selected and correct so we can manipulate below
            ...
            if (selectedCells.length === 0) {
                ...
                if (selectedCells[0].value == cell.value) {
                    ...
                    setTimeout(function () {
                        selectedCells[0].isVisible = false, cell.isVisible = false;
                        _this2.setState({ selectedCells: [] });
                    }, 1500);
                }
            }
        }
        ...
        value: function render() {
            ...
            var rowHeight = width / board.length;
                ...
                board.map(function (row, rid) {
                    ...
                    return _react2.default.createElement(
                        ...
                        row.map(function (cell) {
                            ...
                            return _react2.default.createElement(_Cell2.default, { key: cell.id, cell: cell, checkPairs: _this3.checkPairs });
                        })
                    );
                })
            );
...
var Cell = function Cell(_ref) {
    var cell = _ref.cell,
        checkPairs = _ref.checkPairs;

    return _react2.default.createElement(
        "div",
        { onClick: function onClick() {
                return checkPairs(cell);
            }, className: "cell column" },
        _react2.default.createElement("img", { src: cell.isVisible && cell.value && cell.image }),
        _react2.default.createElement(
            "p",
            null,
